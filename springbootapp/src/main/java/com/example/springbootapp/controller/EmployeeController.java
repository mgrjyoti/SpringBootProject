...
public class EmployeeController {
	...
	public ResponseEntity<EmployeeResponce> delete(@PathVariable long id) {
		Optional<Employee> employee2 =  employeeService.deleteById(id);
		if (employee2.isPresent()) {
			Employee employee3 = employee2.get();
			EmployeeResponce employeeResponce = new EmployeeResponce();
			employeeResponce.setMessage("Employee Deleted Successfully..");
			employeeResponce.setStatus(HttpStatus.OK.value());
			employeeResponce.setEmployee(employee3);
			 return new ResponseEntity<EmployeeResponce>(employeeResponce,HttpStatus.OK);
		}
		else {
			EmployeeResponce employeeResponce = new EmployeeResponce();
...
//	public ResponseEntity<?> deleteAll(@RequestBody Employee employee) {
//	    List<Employee> employees = employeeService.deleteAll(employee);
//
//	    if (!employees.isEmpty()) {
//	        EmployeeResponce employeeResponce = new EmployeeResponce();
//	        employeeResponce.setMessage("Employee data deleted successfully...");
//	        employeeResponce.setStatus(HttpStatus.OK.value());
//	        employeeResponce.setEmployee(null);
...
//	        employeeResponce.setStatus(HttpStatus.NOT_FOUND.value());
//	        employeeResponce.setEmployee(null);
//	        return new ResponseEntity<>(employeeResponce, HttpStatus.NOT_FOUND);
//	    }
//	}
